...
>
    ...
    <div class="flex flex-col gap-4 items-center justify-center">
        <p><b class="pr-2">Email</b> Yochim.Dustin@gmail.com</p>
        <p>
            <b class="pr-2">GitHub</b>
            <a href="https://github.com/DustinYochim" target="_blank" class="text-violet-400"
                >Dustin Yochim<sup class=""
        ...
        <p>
            ...
            <a href="www.linkedin.com/in/dustinyochim" target="_blank" class="text-violet-400"
                >DustinYochim<sup class=""
                    ><span class="text-xs scale-75 pl-0.5"
                        ><i
                            class="fa-solid fa-arrow-up-right-from-square text-xs scale-[75%]"
                        /></span
